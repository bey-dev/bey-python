...
class TestAuth:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_verify(self, client: Bey) -> None:
        auth = client.auth.verify()
        assert_matches_type(object, auth, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_verify(self, client: Bey) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_verify(self, client: Bey) -> None:
...
class TestAsyncAuth:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_verify(self, async_client: AsyncBey) -> None:
        auth = await async_client.auth.verify()
        assert_matches_type(object, auth, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_verify(self, async_client: AsyncBey) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_verify(self, async_client: AsyncBey) -> None:
